...
NOTE: Also you need to install manually the requirements.txt file.
This is how to do it: 
1. Open CMD (With admin and also Python installed already)
2. Type " pip install -r requirements.txt "
3. Wait for it to install
And then open the main tool with the .exe
